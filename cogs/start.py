...
async def setup(bot: commands.Bot):
    ...
    try:
        ...
        print("Cog Added: start.Start")
    except Exception:
        print(f"There was a problem setting up start.Start.")
        print(traceback.format_exc())
    try:
        await bot.add_cog(rainbowbot(bot=bot), override=True)
        print("Cog Added: start.rainbowbot")
    except Exception:
        print(f"There was a problem setting up start.rainbowbot.")
        print(traceback.format_exc())
    try:
        await bot.add_cog(Commands(bot=bot), override=True)
        print("Cog Added: start.Commands")
    except Exception:
        print(f"There was a problem setting up start.Commands.")
        print(traceback.format_exc())
...
async def teardown(bot: commands.Bot):
    try:
        ...
        print("Cog Removed: start.Start")
    except Exception:
        print(f"There was a problem tearing down start.Start.")
        print(traceback.format_exc())
    try:
        await bot.remove_cog("rainbowbot")
        print("Cog Removed: start.rainbowbot")
    except Exception:
        print(f"There was a problem tearing down start.rainbowbot.")
        print(traceback.format_exc())
    try:
        await bot.remove_cog("Commands")
        print("Cog Removed: start.Commands")
    except Exception:
        print(f"There was a problem tearing down start.Commands.")
        print(traceback.format_exc())